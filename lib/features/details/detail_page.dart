              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            child: Container(
                              ...
                              child: const Row(
                                ...
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  Text('ابدأ القراءة', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Colors.white)),
                                ],
                              ),
                            ),
                          ),
                    ...
                    Row(
                      children: [
                        _InfoCard(label: 'الفصول', value: widget.manga.chaptersCount.toString(),
                            dark: dark, cardBg: cardBg, textClr: textClr),
                        const SizedBox(width: 8),
                        _InfoCard(label: 'النوع', value: widget.manga.type,
                            dark: dark, cardBg: cardBg, textClr: textClr),
                        const SizedBox(width: 8),
                        _InfoCard(label: 'الحالة', value: widget.manga.status,
                                  ...
                                  Padding(
                                    ...
                                    child: GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text('عرض المزيد', textAlign: TextAlign.center,
...
class _InfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final valueColor = isStatus
        ? (value == 'مكتملة' ? const Color(0xFFF87171) : const Color(0xFF4ADE80))
        : Colors.white;
